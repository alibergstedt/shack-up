...
BEGIN
	...
	DELETE FROM AspNetUsers WHERE id IN ('00000000-0000-0000-0000-000000000000', '111111111-1111-1111-1111-111111111111');
	...
	INSERT INTO AspNetUsers (Id, EmailConfirmed, PhoneNumberConfirmed, Email,
	StateId, TwoFactorEnabled, LockoutEnabled, AccessFailedCount, UserName)
	VALUES ('00000000-0000-0000-0000-000000000000', 0, 0, 'test@test.com', 'OH', 0,0,0,'test');

	INSERT INTO AspNetUsers (Id, EmailConfirmed, PhoneNumberConfirmed, Email,
	StateId, TwoFactorEnabled, LockoutEnabled, AccessFailedCount, UserName)
	VALUES ('111111111-1111-1111-1111-111111111111', 0, 0, 'test2@test.com', 'OH', 0,0,0,'test2');
	...
	VALUES (1, '111111111-1111-1111-1111-111111111111'),
	(2, '111111111-1111-1111-1111-111111111111')


	
	INSERT INTO Contacts(ListingId, UserId)
	VALUES (1, '111111111-1111-1111-1111-111111111111'),
	(3, '111111111-1111-1111-1111-111111111111')
